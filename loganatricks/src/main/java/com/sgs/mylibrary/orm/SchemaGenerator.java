...
import com.sgs.mylibrary.orm.annotation.Column;
import com.sgs.mylibrary.orm.annotation.MultiUnique;
import com.sgs.mylibrary.orm.annotation.NotNull;
...
import com.sgs.mylibrary.orm.util.KeyWordUtil;
import com.sgs.mylibrary.orm.util.MigrationFileParser;
import com.sgs.mylibrary.orm.util.NumberComparator;
...
import static com.sgs.mylibrary.orm.util.ContextUtil.getAssets;
import static com.sgs.mylibrary.orm.util.ReflectionUtil.getDomainClasses;


/**
 * SchemaGenerator is for supporting sugarRecords
 */
public class SchemaGenerator {
    ...
    /**
     * singleton class for schemagenerator
     * @return
     */
    ...
    /**
     * method is used for creating the database
    ...
    /**
     * method for getting the list of Column names from table
     * @param sqLiteDatabase
     * @param tableName
     * @return
     */
    ...
    /**
     * method for deleting the tables
     * @param sqLiteDatabase
     */
    ...
    /**
     * method for upgrading the sugarRecord
     * @param db
     * @param oldVersion
     * @param newVersion
     * @return
    ...
    /**
     * method for adding the addColumns
     * @param table
     * @param sqLiteDatabase
     */
...
//                }
    ...
    /**
     * method for creating the tableSQL
     * @param table
     * @return
     */
    ...
    /**
     * method for creating creating table
     * @param table
     * @param sqLiteDatabase
     */
