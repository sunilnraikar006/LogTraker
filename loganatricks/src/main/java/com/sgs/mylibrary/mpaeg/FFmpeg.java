...
import com.sgs.mylibrary.R;
import com.sgs.mylibrary.mpaeg.exceptions.FFmpegCommandAlreadyRunningException;
import com.sgs.mylibrary.mpaeg.exceptions.FFmpegNotSupportedException;
...
public class FFmpeg implements FFmpegInterface {
    ...
    public void execute(Map<String, String> environvenmentVars, String[] cmd, FFmpegExecuteResponseHandler ffmpegExecuteResponseHandler) throws FFmpegCommandAlreadyRunningException {
        ...
        if (cmd.length != 0) {
            ...
            ffmpegExecuteAsyncTask = new FFmpegExecuteAsyncTask(context,command , timeout, ffmpegExecuteResponseHandler);
    ...
    public String getDeviceFFmpegVersion() throws FFmpegCommandAlreadyRunningException {
        ...
        CommandResult commandResult = shellCommand.runWaitFor(new String[] {
    ...
    public boolean isFFmpegCommandRunning() {
        ...
        return ffmpegExecuteAsyncTask !=null?
                ...
                !(ffmpegExecuteAsyncTask.getStatus() == AsyncTask.Status.FINISHED) &&
                !(ffmpegExecuteAsyncTask.isCancelled())
        :false;
    }
